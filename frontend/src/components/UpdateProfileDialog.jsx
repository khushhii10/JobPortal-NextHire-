...
const UpdateProfileDialog = ({ open, setOpen }) => {
    ...
    return (
        <div>
            <Dialog open={open}>
                <DialogContent className="sm:max-w-[425px]  bg-white shadow-xl border border-gray-300 dark:bg-gray-900 dark:text-white" onInteractOutside={() => setOpen(false)}>
                    <DialogHeader>
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <DialogFooter>
                            {
                                loading ? <Button className="w-full my-4"><Loader2 className='mr-2 h-4 w-4 animate-spin' />Please wait</Button> : <Button type="submit" className="w-full my-4 bg-black text-white">Update</Button>
                            }
                        </DialogFooter>
                    </form>
                </DialogContent>
